...
// ============================================================
// ROLE CONFIGURATION - FIXED PATHS
// ============================================================
$sidebar = '';
$topbar = '';
$dashboard = '';
...
// Check if sidebar and topbar files exist
if(!file_exists($sidebar)){
    // Try alternative path
    $alt_sidebar = dirname(__FILE__) . "/" . $sidebar;
    if(file_exists($alt_sidebar)){
        $sidebar = $alt_sidebar;
    }
}
...
if(!file_exists($topbar)){
    // Try alternative path
    $alt_topbar = dirname(__FILE__) . "/" . $topbar;
    if(file_exists($alt_topbar)){
        $topbar = $alt_topbar;
    }
}
?>
...
<?php 
// Include sidebar and topbar with absolute paths
if(file_exists($sidebar)){
    include($sidebar);
} else {
    // Try from root
        ...
        <div class="profile-body">
            ...
            <div id="viewProfile">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-card">
                        <div class="icon purple"><i class="fas fa-at"></i></div>
                        <div class="details">
